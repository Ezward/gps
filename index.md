...
The quality of the GPS receiver and it's antenna can mitigate this drift; a higher quality setup will use more satellites, more satellite systems and more satellite frequency bands.  Using more satellites minimized the effect that any single satellite's error will have.  Different radio frequencies are affected differently by ionospheric/atmospheric changes, so muliple frequences mitigates these effects.  All of the extra information can be used to produce more accurate and stable position estimates.
